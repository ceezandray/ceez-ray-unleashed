...
const CastSection = () => {
  return (
    <section id="cast" className="pt-48 pb-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-20">
        ...
        >
          ...
          <h3 className="font-heading text-3xl md:text-5xl text-foreground mb-2">
            ONE <span className="text-primary text-glow-red">FRIENDSHIP.</span>
          </h3>
          <h3 className="font-heading text-3xl md:text-5xl text-foreground mb-6">
